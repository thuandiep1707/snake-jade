    ...
    return(
        <div className="testimonialscard">
            ...
            <div className="testimonialscard_stars">
                {[...Array(value.rate)].map((pro, key)=><i key={key} className="fa-solid fa-star" style={{color: "#F2BC1B", fontSize: '16px'}}/>)}
                {[...Array(5 - value.rate)].map((pro, key)=><i key={key} className="fa-solid fa-star" style={{color: "#c7cedb", fontSize: '16px', opacity: '0.7'}}/>)}
            </div>
